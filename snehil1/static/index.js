...
function randomBgVideo() {
    ...
    document.getElementById("bg-video").src = "static/assets/bg-videos/" + randomBgVideoNo + ".mp4";
}
...
function randomThumbnail() {
    ...
    let randomThumbnailImgNo = Math.floor(Math.random() * 6) + 1;

    document.getElementById("thumbnail").src = "static/assets/thumbnails/" + randomThumbnailImgNo + ".png";
}
...
function changeSong(/* thumbnailImage, */ songName, artist, album, btnNo) {
    ...
    // chnage song
    theSong.src = "static/assets/songs/" + songName;
